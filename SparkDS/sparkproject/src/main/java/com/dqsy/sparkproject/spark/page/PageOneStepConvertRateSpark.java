package com.dqsy.sparkproject.spark.page;
...
import com.dqsy.sparkproject.util.NumberUtils;
...
public class PageOneStepConvertRateSpark {
    ...
    public static void main(String[] args) {
        try {
            ...
            // 3、查询任务，获取任务的参数
            taskid = ParamUtils.getTaskIdFromArgs(args, Constants.SPARK_LOCAL_TASKID_PAGE);
    ...
    private static JavaPairRDD<String, Integer> generateAndMatchPageSplit(
        ...
        return sessionid2actionsRDD.flatMapToPair(
                (PairFlatMapFunction<Tuple2<String, Iterable<Row>>, String, Integer>) tuple -> {
                    // 定义返回list
    ...
    private static long getStartPagePv(JSONObject taskParam,
        ...
        JavaRDD<Long> startPageRDD = sessionid2actionsRDD.flatMap(
                (FlatMapFunction<Tuple2<String, Iterable<Row>>, Long>) tuple -> {
