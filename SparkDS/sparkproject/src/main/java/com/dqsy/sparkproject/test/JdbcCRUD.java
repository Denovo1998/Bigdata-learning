...
//		preparedStatement();
        ...
        try {
            ...
            String sql = "update user_visit_copy set session_id=?";
//			String sql = "select distinct user_id from user_visit";
    ...
    public static int getUserId() {
        ...
        try {
            ...
            conn = DriverManager.getConnection(
                    ...
                    "123456");
            stmt = conn.createStatement();
            String sql = "select user_id from user_visit order by rand() LIMIT 1";
//			String sql = "select distinct user_id from user_visit";
            rs = stmt.executeQuery(sql);
            while (rs.next()) {
                userid = rs.getInt(1);
